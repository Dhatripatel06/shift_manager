            ...
            slivers: [
                  ...
                  child: Obx(() {
                    ...
                    return GridView.count(
                      ...
                      children: [
                        ...
                        EarningCard(
                          title: 'Total Shifts',
                          value: dashCtrl.totalShiftCount.value.toString(),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          // Switch to shifts tab would be handled by parent
                        },
                        child: Text(
                          'View All',
                          style: GoogleFonts.outfit(
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Obx(() {
                    if (dashCtrl.isLoading.value) {
                      return const LoadingShimmer(itemCount: 2, height: 140);
                    }

                    if (dashCtrl.recentShifts.isEmpty) {
                      return const EmptyState(
                        icon: Icons.work_off_outlined,
                        title: 'No shifts yet',
                        subtitle:
                            'Start tracking your shifts by tapping the + button',
                      );
                    }
