...
class SettingsScreen extends StatelessWidget {
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: authCtrl.photoUrl != null
                          ? NetworkImage(authCtrl.photoUrl!)
                          : null,
                      child: authCtrl.photoUrl == null
                          ? Text(
                              authCtrl.displayName.isNotEmpty
                                  ? authCtrl.displayName[0].toUpperCase()
                                  : 'U',
                              style: GoogleFonts.outfit(
                                fontSize: 20,
                                fontWeight: FontWeight.w700,
                ...
                child: Column(
                  children: [
                    ...
                    _settingRow(
                      ...
                      subtitle: 'Restore all shifts from Firebase',
                      isDark: isDark,
                      trailing: IconButton(
                        icon: Icon(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              themeCtrl.isDarkMode.value ? 'Dark' : 'Light',
                              style: GoogleFonts.outfit(
                                fontSize: 12,
                                fontWeight: FontWeight.w600,
                                color: primaryColor,
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () async {
                          try {
                            ...
                            final shifts = ctrl.getAllShiftsForExport();
                            if (shifts.isEmpty) {
                              Get.snackbar(
                                'No Data',
                                'No shifts to export',
  ...
  static Widget _sectionTitle(String t, bool isDark) => Text(
    t,
    style: GoogleFonts.outfit(
      fontSize: 13,
      fontWeight: FontWeight.w600,
  ...
  static Widget _card({required bool isDark, required Widget child}) =>
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isDark
                ? AppColors.cardDarkElevated.withValues(alpha: 0.12)
  ...
  static Widget _divider(bool isDark) => Padding(
    ...
    child: Divider(
      height: 1,
      color: isDark
          ? AppColors.cardDarkElevated.withValues(alpha: 0.1)
          : Colors.grey.withValues(alpha: 0.1),
    ),
  );
  ...
  static void _confirmLogout(AuthController authCtrl) {
    Get.dialog(
      AlertDialog(
        ...
        content: const Text(
          'Are you sure? Your data is safely stored in the cloud.',
        ),
        actions: [
